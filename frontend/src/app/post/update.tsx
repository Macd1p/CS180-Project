        ...
        <DialogPanel className="border bg-white p-5 space-y-2 w-100">
          ...
          <form onSubmit={handleSave}>
            <Field className="flex flex-col mb-2">
              <Label className="font-medium">New Title</Label>
            ...
            <Field className="relative flex flex-col mb-2">
              ...
              <div className="border pl-1 hover:shadow-md border-gray-500 rounded-md cursor-pointer">
                <div className="text-gray-400 cursor-pointer">{image ? image.name : "Upload an image"}</div>
              </div>
            </Field>

            <Field className="flex flex-col mb-2">
              <Label className="font-medium">New Description:</Label>
            ...
            <Field className="flex flex-col mb-2">
              <Label className="font-medium">New Tags:</Label>
